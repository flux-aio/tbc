    ...
    [1] = { name = "General", sections = {
        ...
        { header = "Utility", settings = {
            ...
            { type = "checkbox", key = "use_feint", default = false, label = "Auto Feint",
              tooltip = "Use Feint for threat reduction." },
            { type = "slider", key = "feint_threat_pct", default = 90, min = 50, max = 100,
              label = "Feint Threat (%)", tooltip = "Use Feint above this threat%.", format = "%d%%" },
