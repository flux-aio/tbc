...
-- ============================================================================
local THEME = {
    bg          = { 0.051, 0.051, 0.063, 0.97 },   -- #0d0d10
    bg_light    = { 0.082, 0.082, 0.098, 1 },       -- #151519
    bg_widget   = { 0.102, 0.102, 0.122, 1 },       -- #1a1a1f
    bg_hover    = { 0.118, 0.118, 0.141, 1 },       -- #1e1e24
    border      = { 0.157, 0.157, 0.188, 1 },       -- #282830
    accent      = { 0.424, 0.388, 1.0, 1 },         -- #6c63ff
    accent_dim  = { 0.255, 0.233, 0.6, 1 },         -- #413b99 (dimmed accent)
    accent_bg   = { 0.096, 0.091, 0.175, 1 },       -- accent @ 12% over bg
